...
//    private static Weeks weeks;
     ...
     */
    public Semester(String pName, int pStartYear, int pStartMonth, int pStartDay, int pEndYear, int pEndMonth, int pEndDay) throws IllegalArgumentException {
        this.semesterName = pName;
